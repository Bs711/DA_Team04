...
class MySpider1(scrapy.Spider):  # USE to execute Scrapy
    ...
    def parse(self, response):  # Compulsory function to execute scrapy codes
        ...
        for each_link in self.website_links:
            ...
            yield scrapy.Request(all_links,callback=self.website_other_links)  # Scraping the other websites using a generator something like return but better and sening the response to a function
